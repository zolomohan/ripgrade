...
/**
 * Ask again, now — the wishlist's own press.
 *
    ...
    >
      {busy ? (
        ...
        /* A signal going out, the app's own mark for the indexers, from the
           scope menu in ⌘F. It was a circular arrow once, and a circular arrow
           is the mark for "again" rather than for what is being done again —
           the wrong half of this button to draw, when where it asks is the
           whole of what makes it different from the rail's Scan. */
        <svg
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
